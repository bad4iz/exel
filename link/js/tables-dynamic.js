$(function(){
    ...
    function pageLoad(){
        ...
        //     if ($(this).hasClass( 'no-sort')){
        //         unsortableColumns2.push({"bSortable": false});
        //     } else {
        //         unsortableColumns2.push(null);
        //     }
        // });
        ...
        //         "sLengthMenu": "_MENU_ &nbsp; записей на странице"
        //     },
        //     "aoColumns": unsortableColumns2
        // });

        // var unsortableColumns3 = [];
        // $('#datatable-table-3').find('thead th').each(function(){
        //     if ($(this).hasClass( 'no-sort')){
        //         unsortableColumns3.push({"bSortable": false});
        //     } else {
        //         unsortableColumns3.push(null);
        //     }
        // });
        // $("#datatable-table-3").dataTable({
        //     "sDom": "<'row table-top-control'<'col-md-6 hidden-xs per-page-selector'l><'col-md-6'f>r>t<'row table-bottom-control'<'col-md-6'i><'col-md-6'p>>",
        //     "oLanguage": {
        //         "sLengthMenu": "_MENU_ &nbsp; записей на странице"
        //     },
        //     "aoColumns": unsortableColumns3
        // });
