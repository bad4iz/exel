 ...
 */
export function open_modal(data){//Открытие модального окна с загрузкой контента.
   let answer = {};
    $('.all_modal').html(data);
...
export function exit_modal(){//закрытие и очищение модального окна.
...
let data= `<div class="head_modal">Заголовок окна!</div>
