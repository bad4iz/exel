...
!function ($) {
  ...
  */
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
        defaultMessage: "Вы ввели не верное значение."
      , type: {
            email:      "Укажите пожалуйста электронную почту."
          , url:        "Укажите пожалуйста корректный url-адрес."
          , urlstrict:  "Укажите пожалуйста корректный url-адрес."
          , number:     "Это значение должно содержать только цифры."
          , digits:     "Введите только цифры."
          , dateIso:    "Укажите дату в формате (ДД-ММ-ГГГГ)."
      ...
      , regexp:         "Не правильное значение."
      , min:            "Это значеие должно быть больше %s."
      , max:            "Это значеие должно быть меньше %s."
      , range:          "Это значение должно быть между %s и %s."
      , minlength:      "Это значение является слишком коротким. Оно должно иметь %s или более символов."
      , maxlength:      "Это значение слишком длинное. Оно должно иметь %s или менее символов."
      , rangelength:    "Значение такой длинны является недействительным. Оно должно быть между %s и %s символов."
