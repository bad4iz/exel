...
<!--    <link href="/link/css/application.min.css" rel="stylesheet">-->
...
<!--               data-parent="#side-nav" href="ui_icons.html#forms-collapse"><i class="fa fa-edit"></i> <span class="name">Forms</span></a>-->
...
<!--        </li>-->
<!--        <li class="panel">-->
<!--            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#side-nav" href="ui_icons.html#stats-collapse"><i class="fa fa-bar-chart-o"></i> <span class="name">Statistics</span></a>-->
...
<!--               data-parent="#side-nav" href="ui_icons.html#ui-collapse"><i class="fa fa-magic"></i> <span class="name">User Interface</span></a>-->
...
<!--        <li class="panel">-->
<!--            <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--               data-parent="#side-nav" href="ui_icons.html#components-collapse"><i class="fa fa-bookmark-o"></i> <span class="name">Components</span></a>-->
...
<!--        <li class="panel">-->
<!--            <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--               data-parent="#side-nav" href="ui_icons.html#tables-collapse"><i class="fa fa-table"></i> <span class="name">Tables</span></a>-->
...
<!--        <li class="panel">-->
<!--            <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--               data-parent="#side-nav" href="ui_icons.html#grid-collapse"><i class="fa fa-bars"></i> <span class="name">Grid</span></a>-->
...
<!--        <li class="panel">-->
<!--            <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--               data-parent="#side-nav" href="ui_icons.html#special-collapse"><i class="fa fa-asterisk"></i> <span class="name">Special</span></a>-->
...
<!--        <li class="panel">-->
<!--            <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--               data-parent="#side-nav" href="ui_icons.html#menu-levels-collapse"><i class="fa fa-code-fork"></i> <span class="name">Menu Levels</span></a>-->
<!--            <ul id="menu-levels-collapse" class="panel-collapse collapse">-->
<!--                <li><a href="ui_icons.html#">Item 1.1</a></li>-->
<!--                <li><a href="ui_icons.html#">Item 1.2</a></li>-->
<!--                <li class="panel">-->
<!--                    <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--                       data-parent="#menu-levels-collapse" href="ui_icons.html#sub-menu-1-collapse">Item 1.3</a>-->
<!--                    <ul id="sub-menu-1-collapse" class="panel-collapse collapse">-->
<!--                        <li><a href="ui_icons.html#">Item 2.1</a></li>-->
<!--                        <li><a href="ui_icons.html#">Item 2.2</a></li>-->
<!--                        <li class="panel">-->
<!--                            <a class="accordion-toggle collapsed" data-toggle="collapse"-->
<!--                               data-parent="#sub-menu-2-collapse" href="ui_icons.html#sub-menu-2-collapse">Item 2.3</a>-->
<!--                            <ul id="sub-menu-2-collapse" class="panel-collapse collapse">-->
<!--                                <li><a href="ui_icons.html#">Item 3.1</a></li>-->
<!--                                <li><a href="ui_icons.html#">Item 3.2</a></li>-->
<!--                                <li><a href="ui_icons.html#">Item 3.3</a></li>-->
<!--                            </ul>-->
<!--                        </li>-->
<!--                    </ul>-->
<!--                </li>-->
        ...
        <div class="navbar">
                <ul class="nav navbar-nav navbar-right pull-right">
                    <li class="visible-phone-landscape">
                        <a href="ui_icons.html#" id="search-toggle">
                            <i class="fa fa-search"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="ui_icons.html#" title="Messages" id="messages"
                        ...
                        <ul id="messages-menu" class="dropdown-menu messages" role="menu">
                            <li role="presentation">
                                <a href="ui_icons.html#" class="message">
                            ...
                            <li role="presentation">
                                <a href="ui_icons.html#" class="text-align-center see-all">
                    ...
                    <li class="dropdown">
                        <a href="ui_icons.html#" title="8 support tickets"
                           class="dropdown-toggle"
                           data-toggle="dropdown">
                        ...
                        <ul id="support-menu" class="dropdown-menu support" role="menu">
                            <li role="presentation">
                                <a href="ui_icons.html#" class="support-ticket">
                                    <div class="picture">
                    ...
                    <li class="divider"></li>
                    <li class="hidden-xs">
                        <a href="ui_icons.html#" id="settings"
                           title="Settings"
                           data-toggle="popover"
                    ...
                    <li class="hidden-xs dropdown">
                        <a href="ui_icons.html#" title="Account" id="account"
                           class="dropdown-toggle"
                           data-toggle="dropdown">
                        ...
                        <ul id="account-menu" class="dropdown-menu account" role="menu">
                            ...
                            <li role="presentation">
                                <a href="ui_icons.html#" class="link">
